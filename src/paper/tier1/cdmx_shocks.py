...
from config import (
    POST_COVID_START, TOP_N_SHOCK_DAYS,
...
# Preprocessed multimodal ridership — generated by running the CDMX preprocessing
# step described in data/cdmx/README.md.
# Expected location after preprocessing: data/cdmx/_outputs/afluencia_multimodal_long.csv
CDMX_AFLUENCIA = ROOT / "data" / "cdmx" / "_outputs" / "afluencia_multimodal_long.csv"
...
def load_afluencia() -> pd.DataFrame:
    ...
    """
    if not CDMX_AFLUENCIA.exists():
        raise FileNotFoundError(
            f"CDMX multimodal ridership file not found: {CDMX_AFLUENCIA}\n"
            "Generate it first by placing the raw SEMOVI CSV files in data/cdmx/afluencia/\n"
            "and running the preprocessing step described in data/cdmx/README.md."
        )
